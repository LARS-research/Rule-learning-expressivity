...
@R.register("datasets.UMLS")
class UMLS(data.KnowledgeGraphDataset):
    """
    A filtered version of UMLS dataset without trivial cases.
    ...
    md5s = [
        "0beae7304448af74fae9c2f5e510c45d",
        "288e273e6e0b51e07f4beacf096fe953",
        "e179c95c129ee4f188846322b57d4298"
    ]
    ...
    def __init__(self, path, verbose=1):
        ...
        for url, md5 in zip(self.urls, self.md5s):
            save_file = "umls_%s" % os.path.basename(url)
...
class KINSHIP(data.KnowledgeGraphDataset):
    """
    A filtered version of KINSHIP dataset without trivial cases.
    ...
    urls = [
        "https://raw.githubusercontent.com/ZhenfengLei/KGDatasets/master/Kinship/train.txt",
        "https://raw.githubusercontent.com/ZhenfengLei/KGDatasets/master/Kinship/valid.txt",
        "https://raw.githubusercontent.com/ZhenfengLei/KGDatasets/master/Kinship/test.txt",
    ]
    md5s = [
        "2f0fb8c9de86553b17cf8655c0b11e67",
...
@R.register("datasets.FAMILY")
class FAMILY(data.KnowledgeGraphDataset):
    """
    A filtered version of FAMILY dataset without trivial cases.
    ...
    urls = [
        "https://raw.githubusercontent.com/LARS-research/RED-GNN/main/transductive/data/family/train.txt",
        "https://raw.githubusercontent.com/LARS-research/RED-GNN/main/transductive/data/family/valid.txt",
        "https://raw.githubusercontent.com/LARS-research/RED-GNN/main/transductive/data/family/test.txt"
    ]
    md5s = [
        "8c6185fabaf466667a907e8abf0605c5",
        "c0165a3980bf275ccacd0105f0381554",
        "90c91f90cc2505a06b4a8ac688b8bea1"
    ]
    ...
    def __init__(self, path, verbose=1):
        ...
        for url, md5, fn in zip(self.urls, self.md5s, file_name):
            save_file = "family_%s" % fn
            txt_file = utils.download(url, self.path, save_file=save_file, md5=md5)
            txt_files.append(txt_file)
